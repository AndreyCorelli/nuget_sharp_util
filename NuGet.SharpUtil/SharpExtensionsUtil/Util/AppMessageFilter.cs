...
//        /// Обычный конструктор
//        /// </summary>
//        public ApplicationMessageBinding(ApplicationMessage message, string title, Keys mainKey, WindowMessage messageType)
//        {
//            Message = message;
//            Title = title;//EnumFriendlyName<ApplicationMessage>.GetString(message);
