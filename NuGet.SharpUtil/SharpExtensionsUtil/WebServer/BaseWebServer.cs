...
namespace SharpExtensionsUtil.WebServer
{
    public abstract class BaseWebServer
    {
        ...
        public static readonly bool needAuthentication = AppConfig.GetBooleanParam("WebServer.Authentication", false);
        ...
        {
            return AppConfig.GetIntParam("WebServer.Port", 9010);
        }
